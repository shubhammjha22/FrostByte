  ...
  return (
    <>
      ...
      >
        ...
        <p className="font-semibold text-sm text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-300 dark:group-houver:text-zinc-300 transition ">
          Search
        </p>
